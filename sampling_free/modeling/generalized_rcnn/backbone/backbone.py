...
from ..functions import BACKBONES, conv_with_kaiming_uniform
...
@BACKBONES.register("R-101-FPN")
@BACKBONES.register("R-152-FPN")
...
@BACKBONES.register("R-50-FPN-RETINANET")
@BACKBONES.register("R-101-FPN-RETINANET")
@BACKBONES.register("R-152-FPN-RETINANET")
