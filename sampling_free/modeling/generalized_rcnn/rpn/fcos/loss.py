...
from sampling_free.layers import IOULoss, SigmoidFocalLoss, CELoss
from ...functions import GuidedLoss
...
class FCOSLossComputation(nn.Module):
    ...
    def __call__(self, locations, box_cls, box_regression, centerness, targets):
        ...
        if self.sampling_free:
            return self.guided_loss([cls_loss, reg_loss, centerness_loss], 
