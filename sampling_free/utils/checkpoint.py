...
from sampling_free.utils.c2_model_loading import load_c2_format
from sampling_free.utils.imports import import_file
from sampling_free.utils.model_zoo import cache_url
    ...
    def _load_file(self, f):
        ...
        if f.startswith("catalog://"):
            paths_catalog = import_file(
                "sampling_free.config.paths_catalog", self.cfg.PATHS_CATALOG, True
            )
