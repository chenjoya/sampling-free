...
def _rename_basic_resnet_weights(layer_keys):
    ...
    layer_keys = [k.replace("cls.ssampling_free", "cls_ssampling_free") for k in layer_keys]
...
def _rename_weights_for_resnet(weights, stage_names):
    ...
    # Keypoint R-CNN
    layer_keys = [k.replace("kps.ssampling_free.lowres", "kps_ssampling_free_lowres") for k in layer_keys]
    layer_keys = [k.replace("kps.ssampling_free", "kps_ssampling_free") for k in layer_keys]
