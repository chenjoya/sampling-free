...
import numpy as np
import torch
from paa_sampling_free.layers import nms as box_nms
...
class TestNMS(unittest.TestCase):
    ...
    def test_nms1_cpu(self):
        ...
        ssampling_frees = torch.from_numpy(
            np.array(
                [
                    0.1919,
                    0.3293,
        ...
        keep_indices = box_nms(boxes, ssampling_frees, 0.5)
        keep_indices = np.sort(keep_indices)
