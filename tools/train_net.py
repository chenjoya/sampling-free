...
from sampling_free.solver import make_lr_scheduler
from sampling_free.solver import make_optimizer
from sampling_free.engine.inference import inference
from sampling_free.engine.trainer import do_train
...
def main():
    ...
    logger = setup_logger("sampling_free", output_dir, get_rank())
